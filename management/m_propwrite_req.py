...
cemi_code = bytearray.fromhex("f6")
cemi_object_type = bytearray.fromhex("0000")
cemi_object_instance = bytearray.fromhex("01")
cemi_pid = bytearray.fromhex("33")
cemi_num_elements = bytearray.fromhex("10")
cemi_start_index = bytearray.fromhex("00")
cemi_data = bytearray.fromhex("aaaa")
kip_cemi = cemi_code + cemi_object_type + cemi_object_instance + cemi_pid + cemi_num_elements + cemi_start_index + cemi_data
