...
cemi_tpdu_length = bytearray.fromhex("03") # Length does not include TPCI
cemi_tpdu_apci = bytearray.fromhex("0200") # Memory Read
cemi_tpdu_address = bytearray.fromhex("1234")
cemi_tpdu = cemi_tpdu_length + cemi_tpdu_apci + cemi_tpdu_address
